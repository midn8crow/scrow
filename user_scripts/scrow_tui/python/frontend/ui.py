...
"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.user_presets_dir = (xdg_config / "scrow" / "tui" / self.schema_name).resolve()
        ...
        if self.deferred_load:
            def _deferred_worker():
                try:
                    ...
                    print(f"[ScrowTUI] Deferred load error: {e}", file=sys.stderr)
    ...
    def apply_theme_to_engine(self) -> None:
        ...
        theme_name = "scrow_matugen_A" if self._theme_toggle else "scrow_matugen_B"
    ...
    def action_reset_all(self) -> None:
        ...
        try:
            ...
            print(f"[ScrowTUI] Reset page error: {e}", file=sys.stderr)
