...
"""
===============================================================================
SCROW TUI: HYBRID TRACKPAD ENGINE
===============================================================================
...
ACTION_MAP = {
    ...
    "Toggle Scrow QuickPanel": 'function()\n        hl.exec_cmd([[gdbus call --session --dest org.scrow.quickpanal --object-path /org/scrow/quickpanal --method org.freedesktop.Application.Activate ""]])\n    end',
    "Toggle Waybar": 'function()\n        hl.exec_cmd(scrow_scripts .. "waybar/waybar_toggle.sh")\n    end',
    "Toggle Blur & Opacity": 'function()\n        hl.exec_cmd(scrow_scripts .. "hypr_blur_opacity_shadow_toggle.sh")\n    end',
    "Media: Play / Pause": 'function()\n        hl.exec_cmd(scrow_scripts .. "mako_osd/osd_router/osd_router.sh --play-pause")\n    end',
    "Media: Volume Up (+10%)": 'function()\n        hl.exec_cmd(scrow_scripts .. "mako_osd/osd_router/osd_router.sh --vol-up 10")\n    end',
    "Media: Volume Down (-10%)": 'function()\n        hl.exec_cmd(scrow_scripts .. "mako_osd/osd_router/osd_router.sh --vol-down 10")\n    end',
    "Screen: Brightness Up (+10%)": 'function()\n        hl.exec_cmd(scrow_scripts .. "mako_osd/osd_router/osd_router.sh --bright-up 10")\n    end',
    "Screen: Brightness Down (-10%)": 'function()\n        hl.exec_cmd(scrow_scripts .. "mako_osd/osd_router/osd_router.sh --bright-down 10")\n    end',
...
def get_friendly_name(block_str: str) -> str:
    ...
    if "org.scrow.quickpanal" in block_str: return "Toggle Scrow QuickPanel"
