#!/usr/bin/env python3
"""
Rich UI Interactive Speed Test Runner for Scrow Network Manager.
...
def run_phase(direction: str, script_path: str, live: Live) -> tuple[float | None, bool]:
    ...
    while True:
        ...
        grid.add_row(Text(f"🚀 SCROW {label} SPEED TEST", style=f"bold {color}"))
        grid.add_row(Text(""))
        ...
        grid.add_row(Text(""))
        grid.add_row(Text("Press [q] or [Esc] at any time to stop & return to Scrow TUI", style="bold dim yellow"))
    ...
    try:
        with Live(console=console, refresh_per_second=10) as live:
            ...
            if was_cancelled:
                ...
                summary_grid.add_row(Text("✨ SCROW SPEED TEST COMPLETE ✨", style="bold green"))
            ...
            summary_grid.add_row(Text(""))
            summary_grid.add_row(Text("Returning to Scrow TUI...", style="dim italic"))
