...
hl.curve("snap",             { type = "bezier", points = { {0.5, 0.9}, {0.1, 1.0} } })
hl.curve("menu_decel",       { type = "bezier", points = { {0.1, 1}, {0, 1} } })
hl.curve("liner",            { type = "bezier", points = { {1, 1}, {1, 1} } })
hl.curve("standard",          { type = "bezier", points = { {0.25, 0.1}, {0.25, 1} } })

hl.animation({ leaf = "windowsIn",      enabled = true,  speed = 4,  bezier = "standard" })
hl.animation({ leaf = "windowsOut",     enabled = true,  speed = 4,  bezier = "standard" })
...
hl.animation({ leaf = "workspaces",     enabled = true,  speed = 8,  bezier = "wsOvershot", style = "slidevert" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 8,  bezier = "wsOvershot", style = "slidevert" })
